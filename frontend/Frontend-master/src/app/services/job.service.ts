...
export class JobService {
  ...
  public addJob(job: Job): Observable<any> {
    ...
    return this.http.post("http://localhost:8082/addjobs", job, { headers, responseType: 'text' as 'json' });
  }
  ...
  public getAllJobs(): Observable<any> {
    ...
    const headers = new HttpHeaders().set('Content-Type', 'application/json; charset=utf-8');
    return this.http.get(`${this.baseUrl}/alldetails`, { headers, responseType: 'json' });
  }
